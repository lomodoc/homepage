...
You can use Lomorage Web client to upload photos/videos from desktop/laptop using browser, and you can use the gallery to view the photos/videos stored in Lomorage. You can also open the Inbox to view photos/videos shared with you by other family members.
