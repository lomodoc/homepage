...
If you are using "Lomorage Photo Assistant" in MacOS, then you can just click "import" menu item in Lomorage Photo Assistant Application, and it will open the web application.
